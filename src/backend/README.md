...
**Arquivo**: `src/services/ConsolidatorService.ts`
...
**Arquivo**: `src/services/EventIndexerService.ts`
...
#### 3.2 DrawController
**Arquivo**: `src/controllers/DrawController.ts`
...
#### 3.3 StatsController
**Arquivo**: `src/controllers/StatsController.ts`
...
#### 5.2 Merkle Utils
**Arquivo**: `src/utils/MerkleTree.ts`
...
**Arquivo**: `src/utils/RandomnessDerivation.ts`
...
#### 6.2 Monitoring Jobs
**Arquivo**: `src/jobs/MonitoringJobs.ts`
...
**Arquivo**: `src/config/blockchain.ts`

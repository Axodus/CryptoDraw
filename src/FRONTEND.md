...
│   │   ├── hooks/         # Custom hooks específicos do frontend
...
### 1. Home Page (`/`)
**Arquivo**: `src/frontend/src/app/page.tsx`
...
**Arquivo**: `src/frontend/src/app/lotofacil/page.tsx`
...
**Arquivo**: `src/frontend/src/app/supersete/page.tsx`
...
**Arquivo**: `src/frontend/src/app/tickets/page.tsx`
...
**Arquivo**: `src/frontend/src/app/results/page.tsx`
...
#### 1.1 NumberSelector
**Arquivo**: `src/components/game/NumberSelector.tsx` (compartilhado) ou `src/frontend/src/components/game/NumberSelector.tsx`
...
**Arquivo**: `src/components/game/ColumnSelector.tsx` (compartilhado) ou `src/frontend/src/components/game/ColumnSelector.tsx`
...
#### 1.3 TicketPurchase
**Arquivo**: `src/components/game/TicketPurchase.tsx` (compartilhado) ou `src/frontend/src/components/game/TicketPurchase.tsx`
...
**Arquivo**: `src/components/wallet/WalletConnection.tsx` (compartilhado) ou `src/frontend/src/components/wallet/WalletConnection.tsx`
...
#### 2.2 NetworkSelector
**Arquivo**: `src/components/wallet/NetworkSelector.tsx` (compartilhado) ou `src/frontend/src/components/wallet/NetworkSelector.tsx`
...
#### 3.1 TicketCard
**Arquivo**: `src/components/ticket/TicketCard.tsx` (compartilhado) ou `src/frontend/src/components/ticket/TicketCard.tsx`
...
#### 3.2 ClaimButton
**Arquivo**: `src/components/ticket/ClaimButton.tsx` (compartilhado) ou `src/frontend/src/components/ticket/ClaimButton.tsx`
...
#### 4.1 DrawResults
**Arquivo**: `src/components/results/DrawResults.tsx` (compartilhado) ou `src/frontend/src/components/results/DrawResults.tsx`
...
#### 4.2 StatisticsPanel
**Arquivo**: `src/components/results/StatisticsPanel.tsx` (compartilhado) ou `src/frontend/src/components/results/StatisticsPanel.tsx`
...
#### 1.1 useBuyTicket
**Arquivo**: `src/hooks/useBuyTicket.ts` (compartilhado) ou `src/frontend/src/hooks/useBuyTicket.ts`
...
#### 1.2 useClaimPrize
**Arquivo**: `src/hooks/useClaimPrize.ts` (compartilhado) ou `src/frontend/src/hooks/useClaimPrize.ts`
...
#### 2.1 useUserTickets
**Arquivo**: `src/hooks/useUserTickets.ts` (compartilhado) ou `src/frontend/src/hooks/useUserTickets.ts`
...
#### 2.2 useDraw
**Arquivo**: `src/hooks/useDraw.ts` (compartilhado) ou `src/frontend/src/hooks/useDraw.ts`
...
### 1. Game Store
**Arquivo**: `src/frontend/src/stores/gameStore.ts`
...
### 2. Wallet Store
**Arquivo**: `src/frontend/src/stores/walletStore.ts`
...
### 2. Form Validation
**Arquivo**: `src/utils/validation.ts` (compartilhado) ou `src/frontend/src/utils/validation.ts`
...
### 1. Wagmi Config
**Arquivo**: `src/frontend/src/lib/wagmi.ts`
...
### 2. Contract Config
**Arquivo**: `src/frontend/src/lib/contracts.ts` ou `src/config/contracts.ts` (compartilhado)
...
- [ ] Configurar Vite + React com TypeScript
- [ ] Instalar e configurar Tailwind + Shadcn
- [ ] Configurar REOWN AppKit + Wagmi
- [ ] Implementar páginas principais em `src/frontend/src/app/`
- [ ] Criar componentes de jogo (compartilhados em `src/components/`)
- [ ] Implementar seletores de números
- [ ] Criar hooks de contrato (compartilhados em `src/hooks/`)
- [ ] Implementar stores Zustand em `src/frontend/src/stores/`
- [ ] Adicionar validação de forms (compartilhada em `src/utils/`)
- [ ] Utilizar utilitários de packing compartilhados
